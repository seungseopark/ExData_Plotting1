## plot4.R
##
## Constructs Date/Time vs 'Multiple Base Plots' and saves it 
...
## Plots 2x2 Date/Time vs 'Multiple Base' X-Y plots to a PNG file
Sys.setlocale("LC_ALL", 'en_US.UTF-8')  # Set locales to make the same plot
png(file = "plot4.png", width = 480, height = 480, bg = "transparent")
par(mfcol = c(2, 2))
## Left upper plot
plot(dataSet$Date_time, dataSet$Global_active_power, type = "l",
...
## Right upper plot
plot(dataSet$Date_time, dataSet$Voltage, type = "l",
     xlab = "datetime", ylab = "Voltage")
## Right lower plot
plot(dataSet$Date_time, dataSet$Global_reactive_power, type = "l",
